  ...
  return (
    <div>
      <h1>Internship Logs</h1>
        ...
        <b>October 12</b>
        <br />
        Today, I published this website. This took most of the time. I am unsure on how to update the website so I will learn that tomorrow.
        The link to the old version of my website in the chat for you to take a look at.
         I also created working tabs in the navigation bar. Fabien helped me with creating
        and making it work. Tomorrow I will make the navigation bar easier on the eyes and begin learning JavaScript.
        <br />
        <br />
        <b>October 13</b>
        <br />
        ...
        just so I can get a feel of what JS is about, I will remove that soon. I then  the node to my computer to use in the terminal to react. I am
        ...
        have anything done code wise. I want to catch up to Fabien a little bit, so I am going to convert some of my code over to js on the weekend when I have
        the time. I do not have much experience with React as I just started with the program.
        <br />
        <br />
        <b>Ocotober 24</b>
        <br />
        ...
        is too small. I tried to do this as I was making the navbar, so they are both half done. Posted below is what I have so far in React JS. This is only going to
        here for the time being as I shift over to my new website
        <br />
        <br />
        <b>Ocotober 25</b>
        <br />
        ...
        I have also tried to publish my react app but I am not sure if it has been uploaded or not. I don't think I must've done something wrong. I think
        that I have learned a lot about React JavaScript, and feel that I was very productive today. From yesterday, I was not able to get the menu icon
        ...
        my React App header so you can see my progress on the other application.
        <br />
        <br />
        <b>Ocotober 26</b>
        <br />
        Today I continued with my work from the other day. I spent most of my day trying to get navigation tabs to go to different parts of my website.
        I could not make the tabs work, the tutorial must have been out dated so my code would not work. I also re-did what I did yesterday because the tutorial
        that I was following yesterday was more complex than it needed to be so I rewrote my code differently which did not take much time at all. I then tried to
        ...
        <b>October 27</b>
        <br />
        Today, I finally hosted my react application. I then moved my nav bar over to a separate file from the app.js to make it less confusing in the Explorer tab.
        ...
        <b>October 31</b>
        <br />
        Today, I tried to fix the bugs in my code that I didn't realize yesterday. Some of the bugs I attempted to fix were the Navigation Bar hover feature.
        When you hover your cursor over the buttons both the tabs would highlight, I don't know why this was happening because on my other code it works perfectly
        fine. Another problem that occurred today that is familiar to me is the underline under the Navigation tab will not remove, with text decorations, I have
        ...
        <b>November 1</b>
        <br />
        At the beginning, Fabien and I worked on our presentation for tomorrow morning. We have written down and memorized so many points for tomorrow. I then
        I began editing my code. I seemingly did not do anything to my code but it had a bug I could not find. I spent very long on this and I had to because I
        could not progress without it. Google did not help me because I did everything correct. I just accidentally deleted a closing bracket from my function.
        ...
        <b>November 3</b>
        <br />
        Today, I began researching API. I now have an understanding of the concept. Then we talked about a new project where you want me to create a new
        ...
        I then tried to run the local host but got an error message and googled how to fix it. I tried many things but none of them worked, at least I think
        I will try again tomorrow. I then put a pause on the "Our expertise" project and then worked on fixing my website "Error 404" message. Once I fixed that issue
        I then moved over all my old Internship logs to this website.
        <br />
        <br />
        <b>November 4</b>
        <br />
        I began the day trying to figure out a bug I had from yesterday. When I used npm start, I would get an error message say that I did not have "react-start"
        variable declared. It was odd because in the json file I did have it declared. I solved this issue by re-downloading npm install, this did not work but
        when I added npm install -f, it then forced the download and then I could finally run the North P & D local host. I then was told to fix another outstanding
        issue I had from my personal website. The issue was, when you clicked on a tab in the navigation bar it properly took you to the correct page, but when
        if you refreshed the page you would get an error 404 message. To fix this I added a base name and 404.html page, I followed a tutorial to do so. The tutorial
        must have been outdated because some of the steps were wrong and ultimately made my program worse and had more bugs. I asked Fabien how to fix this and he said
        ...
        and everything we need to know when beginning work on your website. I made a mistake when getting North p&D onto VS and had to start over again, which wasn't a
        ...
        near as long as it took last week. I then pushed the branch to github, and that task is complete. I then went back to the Our Expertise task. I added a 'react-router-dom'
        to the json package. I then began writing code for the Our Expertise page, the code I wrote is just importing. I did not write much because I was trying to
        figure out how to add a react router, and what exactly it is. That is what I spent my day on.
        <br />
        <br />
        <b>November 8</b>
        <br />
        We began the date with a standup meeting, we talked about PR and my 'update-address' PR and said that I edited multiple files instead of just one. I then
        fixed the issue, it took a while because I changed a lot more than I thought, especially in 'yarn.lock'. Once I fixed all those changes I went back to
        ...
        all my changes back to the original errors, I restarted then ran out of time. I have done a lot of stuff today but nothing concrete, most things I had to delete, hopefully
        ...
        it should have been fixed, nonetheless I solved the issues. I then begun trying to add react router to your website, but before I could manage to get any work
        ...
        I created the react project which helped me a ton. I then began following your instructions on Discord on what to do. Once I realized I was in the wrong
        test router project file I started again in the correct one, which did not take up too much time. I then went back to the tutorial and followed the steps.
        The steps are much more straightforward when you start on a fresh react app. I then wrote my internship log and ended the day.
        <br />
        <br />
        <b>November 11</b>
        <br />
        ...
        asked me to make to the code does not work anymore with JavaScript, or so I think I could have missed something prior but the code still did what it needed
        ...
        add that to my website, when I can. I have gotten through a lot of the tutorial but there is a lot more, it took me longer to follow the tutorial because I
        I wanted to read over the code to try to figure out what it does, I think reading the code helps me for the future by giving me something to reference. All
        In all, I think today was a very productive day compared to the last few days. I also pushed my code into github if you want to check it out.
        <br />
        <br />
        <b>November 14</b>
        <br />
        We were asked to end our Internship Logs for confidentiality.
    </div>
  );
}
